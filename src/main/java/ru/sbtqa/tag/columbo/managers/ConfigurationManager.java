package ru.sbtqa.tag.columbo.managers;
...
import ru.sbtqa.tag.columbo.units.Configuration;
import ru.sbtqa.tag.columbo.utils.XmlConverter;
...
/**
 * For useful working with configuration
 *
...
public class ConfigurationManager {
    ...
    private static final String CONFIG_FILE = "columbo.conf";
